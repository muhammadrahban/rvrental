                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                    <a href="{{route('list-rv',$destination->id)}}" class="room">
                        <figure class="img-wrap">
                            <img src="{{url('uploads', $destination->image)}}" alt="Free website template" class="img-fluid mb-3">
                        </figure>
                        <div class="p-3 text-center room-info">
                            <h2>{{$destination->name}}</h2>
                            {{-- <span class="text-uppercase letter-spacing-1">{{$destination->price}}$ / per night</span> --}}
                        </div>
                    </a>
                </div>
            @endforeach
