        ...
        <div class="container-fluid animatedParent animateOnce my-3">
            <div class="animated fadeInUpShort go">
               ...
               <div class="tab-pane fade active show" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    <div class="row">
                        <div class="col-md-6">
                            <form class="form-horizontal" action="{{route('users.profile')}}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">Name</label>

                                    <div class="col-sm-10">
                                        <input class="form-control" id="inputName" placeholder="Name" name="username" type="text" value="{{ !empty(auth()->user()->name) ? auth()->user()->name : '' }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="inputEmail" placeholder="Email" name="email" type="email" value="{{ !empty(auth()->user()->email) ? auth()->user()->email : '' }} ">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <form class="form-horizontal" action="{{route('user.user_password')}}" method="POST">
                                @csrf
                                <div class="form-group">
