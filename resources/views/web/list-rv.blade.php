...
@section('title', 'List RV')
@section('content')
<section class="site-hero overlay" style="background-image: url({{ !empty($des->image) ? url('uploads/', $des->image) : asset('front/images/kevin-schmid--grs8iMGqQE-unsplash.jpg') }})"
    data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
            <div class="col-md-10 text-center" data-aos="fade-up">
                <span class="custom-caption text-uppercase text-white d-block  mb-3">Welcome To RV Wala <span
                        class="fa fa-star text-primary"></span> Hotel</span>
                <h1 class="heading">{{$des->name}}</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            @foreach ($rvs as $rv)
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                    <a href="{{route('web-detail',$rv->id)}}" class="room">
